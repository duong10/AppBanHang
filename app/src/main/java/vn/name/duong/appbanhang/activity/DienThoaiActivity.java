...
import vn.name.duong.appbanhang.adapter.DienThoaiAdapter;
...
//Load thêm sản phẩm khi kéo xuống
                ...
                .subscribe(
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                ...
                                Toast.makeText(getApplicationContext(), "Khong con san pham nao",Toast.LENGTH_SHORT).show();
                                isLoading = true;
                            }
                        },
                        throwable -> {
                            Toast.makeText(getApplicationContext(), "Khong ket noi duoc toi du lieu", Toast.LENGTH_LONG).show();
                        }
                ));
    }
